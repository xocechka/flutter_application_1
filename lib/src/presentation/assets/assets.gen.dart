...
class $AssetsFixturesGen {
  ...
  /// File path: assets/fixtures/notario_model.json
  String get notarioModel => 'assets/fixtures/notario_model.json';

  /// File path: assets/fixtures/text_model.json
...
class Assets {
  ...
  static const String textosNotario = 'assets/textos_notario.json';

  /// List of all assets
  List<String> get values => [textosNotario];
}
